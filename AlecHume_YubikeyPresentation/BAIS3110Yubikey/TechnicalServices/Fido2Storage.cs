...
using BAIS3110Yubikey.Data;

namespace BAIS3110Yubikey.TechnicalServices
{
    public class Fido2Storage
    {
        private readonly ApplicationDbContext _applicationDbContext;

        public Fido2Storage(ApplicationDbContext identityDbContext)
        {
            _applicationDbContext = identityDbContext;
        }
